...
function SideBar({setIsSideBarOpen , isSideBarOpen}) {
  ...
  return (
    <div>
      <div
      className={isSideBarOpen ? 'min-w-[261px] bg-white dark:bg-[#2b2c37] fixed top-[72px] h-screen items-center left-0 z-20' : 'bg-[#635fc7] dark:bg-[#2bbcc37] dark:hover:bg-[#635fc7] top-auto bottom -10 justify-center items-center hover:opacity-80 cursor-pointer p-0 transition-duration:300 transform fixed w-[56px] h-[48px] rounder-r-full'}
      >
        <div>
          {/*Rewrite Model*/}
                  ...
                  <div>
                    {boards.map((board, index) =>(
                      ...
                      >
                        ...
                        <p className='text-ig font-blood'>
                          {board.name}
                        </p>
